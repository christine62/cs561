 ...
 * (e.g., for February, show average sales of January and March. For “before” January and “after” December, display <NULL>. 
...
public class Assignment2_2 {
	...
	Assignment2_2() {																	//main multi-dimensional array list, each arraylist member of "info" contains
	...
	public static void main(String[] args) {
		Assignment2_2 cvar = new Assignment2_2();											// object of the class created- cvar= class variable
		String url = "jdbc:postgresql://localhost:5432/"; 					        // url
